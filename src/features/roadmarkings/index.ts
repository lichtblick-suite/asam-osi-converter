...
export function buildRoadMarkingEntity(
  ...
  if (
    roadMarking.id &&
    roadMarking.base?.position &&
    roadMarking.base.orientation &&
    roadMarking.base.dimension &&
    roadMarking.classification
  ) {
    if (
      roadMarking.classification.traffic_main_sign_type !==
      TrafficSign_MainSign_Classification_Type.TYPE_STOP
    ) {
      return undefined;
    }
    ...
    throw Error("Missing road marking information.");
  }
}
