...
export const buildBrakeLight = (moving_obj: MovingObject, side: BrakeLightSide): CubePrimitive => {
  if (
    moving_obj.vehicle_classification?.light_state &&
    moving_obj.base?.dimension &&
    moving_obj.base.orientation &&
    moving_obj.base.position
  ) {
    ...
    throw Error("Missing brake light information.");
  }
};
